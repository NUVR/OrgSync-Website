	...
	<div class="content">
		...
		<div class="width page-body">
			<section class="contact-page">
				...
				<p>Our meetings are weekly at the time and location listed in the footer of every page. For all matters and/or inquiries related to Northeastern Virtual Reality, please use the contact form. If you'd like to get in touch with any of the administrative board, our emails are linked to our profiles on the 'About' page as 'mailto:' links. This organization is registered to Northeastern University, 360 Huntington Ave, Boston, MA 02115.
			</right>
		</section>
	</div>
</div>
